...
<body>
    ...
    <div class="container-full">
        ...
        <div style="text-align:center;">
            @if ($from && $to)
                <span style="font-weight: bold">RAPPORT FINANCIER, (Rubriques non planifiés)</span> Du
                {{ $from }} au {{ $to }}
            @else
                <span style="font-weight: bold">RAPPORT FINANCIER, (Rubriques non planifiés)</span> au
                {{ date('d/m/Y') }}
            @endif
        </div>

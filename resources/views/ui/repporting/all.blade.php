            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class=" nav-item nav-link" id="nav-rubrique-tab" data-toggle="tab" href="#nav-rubrique"
                        ...
                        rubrique</a>
                    <a class=" nav-item nav-link" id="nav-rubrique-not-tab" data-toggle="tab" href="#nav-rubrique-not"
                        role="tab" aria-controls="nav-rubrique-not" aria-selected="true">Etat financier par
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 pt-1 pb-1">
                                <div class="input-group input-daterange" style="float:right">
                                    <input required value="{{ $from }}" name='from' type="date"
                                        class="form-control">
                                    <input required value="{{ $to }}" name='to' type="date"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-md-2 pt-1 pb-1">
                                <button type="submit" href="" style="color: #fff;float:right"
                                    class="btn btn-sm btn-info"><i class="fas fa-filter"></i> Filtrer</button>
                            </div>
                            <div class="col-md-2 pt-1 pb-1">
                                @if ($to && $from && count($transactions) > 0)
                                    <a href="{{ route('executionPdf', ['id' => $budgeting->id, 'from' => $from, 'to' => $to]) }}"
                                        style="float:right" class="text-light btn btn-sm btn-secondary"><i
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($line_budgetings as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-size: 10px;text-align:right">
                                                    <span class="numberFormat">{{ $item->amount - $amountReal }}</span>
                                                    {{ $budgeting->currency->currency }}
                                                </td>
                                                    ...
                                                    @foreach ($line_budgetings as $item)
                                                        @if ($item->rubrique->typeRubrique->state == 1)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="font-size: 10px;text-align:right">
                                                                    <span class="numberFormat">{{ $amountRealRec }}</span>
                                                                    {{ $budgeting->currency->currency }}
                                                                </td>
                                                                <td style="font-size: 10px;text-align:right">
                                                                    <span
                ...
                <div class="tab-pane p-10 fade " id="nav-rubrique-not" role="tabpanel"
                    ...
                    <div class="row">
                        <form action="{{ route('repportings', ['id' => $budgeting->id]) }}" method="get">
                            <div class="row">
                                ...
                                <div class="col-md-2 pt-1 pb-1">
                                    @if ($to && $from && count($transactions) > 0)
                                        <a href="{{ route('executionNotPdf', ['id' => $budgeting->id, 'from' => $from, 'to' => $to]) }}"
                                            style="float:right" class="text-light btn btn-sm btn-secondary"><i
                                                class="fas fa-download"></i>
                                            Téléchager</a>
                                    @endif
                    ...
                    <div class="d-flex align-items-start">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="sendNot-content" role="tabpanel" aria-labelledby="sendNot">
                                <div class="row" style="height: 70vh;overflow:scroll">
                                    <div style="width:72vw" class="col">
                                        @if (count($line_budgetings) > 0)
                                            <table id="_config"
                ...
                <div class="tab-pane pt-10 fade " id="nav-journal" role="tabpanel" aria-labelledby="nav-journal-tab">
                    <form action="{{ route('repportings', ['id' => $budgeting->id]) }}" method="get">
                        <div class="row">
                            ...
                            <div class="col-md-2 pt-1 pb-1">
                                @if ($to && $from && count($transactions) > 0)
                                    <a href="{{ route('transactionPdf', ['id' => $budgeting->id, 'from' => $from, 'to' => $to]) }}"
                                        style="float:right" class="text-light btn btn-sm btn-secondary"><i
                                            class="fas fa-download"></i>
                                        Téléchager</a>
                                @endif

...
Route::middleware('auth')->group(function () {
    ...
    Route::get('user/update/profile/my', [UserController::class, 'showProfile'])->name('users.profile.show');
    Route::get('user/update/reset-password/{id}', [UserController::class, 'resetPassword'])->name('users.reset.password');
    Route::post('user/update/update-password/profile/{id}', [UserController::class, 'updatePassword'])->name('users.update.profile.password');
